...
<main class="bg-white">
    <div class="mx-auto max-w-7xl px-6 lg:px-8 py-12 lg:py-16">
        <header class="mb-8">
            <h1 class="text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl"><?php esc_html_e('Events & webinars', 'neways'); ?></h1>
        </header>
        ...
        <section class="mb-12">
            <h2 class="text-2xl font-bold text-gray-900 mb-6"><?php esc_html_e('Upcoming', 'neways'); ?></h2>
        ...
        <!-- Past Events Section -->
        <section>
            <h2 class="text-2xl font-bold text-gray-900 mb-6"><?php esc_html_e('Past', 'neways'); ?></h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
